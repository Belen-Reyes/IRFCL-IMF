# ----------------------------- Descarga de datos ------------------------------
# Descarga de datos del IRCL-IMF a travé sde un API. Actualizado 01/10/2020
...
# Indicadors paa todos lo paises en valores porcentuales
INDICATOR_P <- TOTAL[3:29]/TOTAL$RAFAFX_USD
